 ...
 * code is useful since its unlikely to change as often as
 * the application code.  So all the libraries that we reference
 ...
 * which should be less frequent.  Any files that aren't referenced
